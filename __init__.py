...
class SmartEjectBase(InterfaceActionBase):
    ...
    SmartEjectPlugin and is defined in the smarteject_plugin.py file, as
    ...
    actual_plugin       = 'calibre_plugins.smarteject.smarteject_plugin:SmartEjectPlugin'
    ...
    def config_widget(self):
        ...
        from calibre_plugins.smarteject.config import ConfigWidget
